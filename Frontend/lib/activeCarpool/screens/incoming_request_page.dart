              ...
              if (snapshot.connectionState == ConnectionState.done){
                ...
                return Stack(children: [
                  ...
                  Column(children: [
                    ...
                    Spacer(flex: 40),
                    Row(children: [
                      JeffeButton(text: "Accept", onTap: ()=>{}, size: 200, buttoncolor: loginTitleColor, textColor: Colors.white,),
                      Spacer(flex: 4),
                      JeffeButton(text: "Reject", onTap: ()=>{}, size: 200, buttoncolor: loginTitleColor, textColor: Colors.white,),
                    ],),
                    Spacer(flex:10),
                  ],)
                ],);
